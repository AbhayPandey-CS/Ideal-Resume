<%@page import="com.resume.helper.ConnectionProvider"%>
<%@page import="com.resume.entities.Message1"%>
<%@page import="com.resume.entities.Users"%>
<%@page import="com.resume.dao.UsersDao"%>
<%@page import="com.resume.dao.ContentDao"%>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header text-white text-center" style="background:#4481eb">
                        <h5 class="modal-title" id="exampleModalLabel"> Ideal Resume </h5>
				...
				<div
					...
					<div class="hero-text">
						...
						<h1 class="text-white" data-aos="fade-up">Do you know?
							Ideal Resume makes it easy to build an effective resume in just
							few minutes.</h1>
	...
	<div id="id01" class="tmodal">
		...
		<form class="tmodal-content animate" action="/Resume_builder.jsp">
			<div class="tcontainer">
				<h2 class="text-white" style="border-bottom: 3px solid var(--primary-color);">Which format do want to make your Resume?</h2>
				<div class="card-deck">
					<div class="card">
		...
		<div class="container" data-aos="fade-up" data-aos-delay="100">
			...
			<div class="row">
				<div class="col-lg-6 blockquote">
					<h2>Why good resume is important?</h2>

					<p>A good resume format will help you highlight your marketable
						traits and downplay your weaknesses. Choose the right one, and you can
			...
			<div class="row">
				...
				<div class="col-lg-5 mx-lg-auto col-md-8 col-10">
					<h1 class="text-white" data-aos="fade-up" data-aos-delay="100">
						Ideal Resume helps you to make <strong>Standard,
				...
				<div class="col-lg-3 col-md-6 col-12" data-aos="fade-up"
					...
					<p class="mb-1">
						...
						improve there chances of success for the job hunt.
					</p>
				</div>
				...
				<div class="col-lg-4 mx-lg-auto text-center col-md-8 col-12"
					...
					<p class="copyright-text">
						Copyright &copy; 2022 Ideal Resume<br>
					</p>
				</div>
