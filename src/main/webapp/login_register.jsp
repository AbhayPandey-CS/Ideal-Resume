...
<html lang="en">
  <head>
    ...
    <title>Login in Ideal Resume</title>
  </head>
  <body>
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form id="signup-form" action="SignupServlet" class="sign-up-form" method="GET">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>New here ?</h3>
            <!-- <p>
              Most welcome to EasyResume, Do you know? Ideal resume makes you easy to build an effective resume in just few minutes.
            </p> -->
            <p>
              Are you new here? You can join us by clicking on the sign up button and create an account to get started.
            </p>
        ...
        <div class="panel right-panel">
          <div class="content">
            <h3>One of us ?</h3>
            <p>  
              Are you already joined to us? Then click on sign in!
            </p>
